...
contract ERC20 is Initializable, IERC20 {
    ...
    */
    ...
    function transferFrom(address from, address to, uint256 value) public returns (bool) {
        require(value <= _allowed[from][msg.sender], "allowance is smaller than the value to transfer");
    ...
    */
    ...
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "account must not be 0x0");
        require(amount <= _balances[account], "balance is smaller than the amount to burn");
